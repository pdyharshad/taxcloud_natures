...
def migrate(cr, version):
    ...
    cr.execute('''update ir_ui_view  set active=True where name like 'res.config.settings.view.form.inherit.sale.amazon.taxcloud' and arch_fs like '%sale_account_taxcloud_tc%' and active=False returning id''')
